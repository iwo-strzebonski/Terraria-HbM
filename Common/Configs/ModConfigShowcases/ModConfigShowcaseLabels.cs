using TerrariaHbM.Common.Configs.CustomDataTypes;
...
namespace TerrariaHbM.Common.Configs.ModConfigShowcases
{
	...
	public class ModConfigShowcaseLabels : ModConfig
	{
		...
		// By default, all ModConfig fields and properties will have an automatically assigned Label and Tooltip translation key. You'll find these translation keys in your translation files. All of the English translations for the configs in TerrariaHbM are found in TerrariaHbM/Localization/en-US_Mods.TerrariaHbM.Configs.hjson
		...
		[LabelKey("$Mods.TerrariaHbM.Configs.Common.LocalizedLabel")]
		[TooltipKey("$Mods.TerrariaHbM.Configs.Common.LocalizedTooltip")]
		...
		// Note: using nameof can help avoid typos and errors. That would look like: $"$Mods.TerrariaHbM.Items.{nameof(ExampleYoyo)}.DisplayName"
		// Note: These examples use color and item chat tags. See here for help on using Tags: https://terraria.wiki.gg/wiki/Chat#Tags
		const string InterpolatedLabel = "$Mods.TerrariaHbM.Configs.Common.InterpolatedLabel";
		const string InterpolatedTooltip = "$Mods.TerrariaHbM.Configs.Common.InterpolatedTooltip";

		[LabelKey(InterpolatedLabel), TooltipKey(InterpolatedTooltip)] // Attributes can also be combined into a single line
		[LabelArgs("TerrariaHbM/ExampleYoyo", 1, "=>", "$Mods.TerrariaHbM.Items.ExampleYoyo.DisplayName")]
		[TooltipArgs("$Mods.TerrariaHbM.Items.ExampleYoyo.DisplayName", "FF55AA", "22a2dd")]
		public bool InterpolatedTextA;

		// [LabelKey(InterpolatedLabel), TooltipKey(InterpolatedTooltip)]
		// [LabelArgs("TerrariaHbM/ExampleSword", 2, "=>", "$Items.ExampleSword.DisplayName")] // due to scope simplification, "Mods.TerrariaHbM." can be omitted. (https://github.com/tModLoader/tModLoader/wiki/Localization#scope-simplification)
		// [TooltipArgs("$Mods.TerrariaHbM.Items.ExampleSword.DisplayName", "77bd8e", "88AADD")]
		...
		// Using [Header("HeaderIdentifier")], Mods.TerrariaHbM.Configs.ModConfigShowcaseLabels.Headers.HeaderIdentifier will automatically appear in localization files. We have populated the English entry with the value "Headers Section".
		...
		[Header("$Mods.TerrariaHbM.Configs.Common.LocalizedHeader")]
