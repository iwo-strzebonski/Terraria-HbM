...
namespace TerrariaHbM.Common.Systems
{
	...
	{
		public static bool downedBillCipherBoss = false;
		// public static bool downedOtherBoss = false;

		public override void ClearWorld()
		{
			downedBillCipherBoss = false;
		...
		{
			if (downedBillCipherBoss)
			{
				tag["downedBillCipherBoss"] = true;
			}
		...
		{
			downedBillCipherBoss = tag.ContainsKey("downedBillCipherBoss");
		...
		public override void NetSend(BinaryWriter writer)
		{
			...
			*/
			...
			// BitsByte flags = new BitsByte(downedBillCipherBoss, downedOtherBoss);
			// writer.Write(flags);
		...
		public override void NetReceive(BinaryReader reader)
		{
			...
			downedBillCipherBoss = bitArray[0];
