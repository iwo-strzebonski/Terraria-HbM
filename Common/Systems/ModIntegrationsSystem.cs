...
namespace TerrariaHbM.Common.Systems
{
	...
	// In addition to the examples shown here, TerrariaHbM also integrates with the Census Mod (https://steamcommunity.com/sharedfiles/filedetails/?id=2687866031)
	...
	public class ModIntegrationsSystem : ModSystem
	{
		...
		{
			/* TODO: Uncomment this method to enable the integration
