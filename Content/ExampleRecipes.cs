...
namespace TerrariaHbM.Content
{
	...
	public class ExampleRecipes : ModSystem
	{
		...
		public override void AddRecipeGroups()
		{
			...
			RecipeGroup.RegisterGroup("TerrariaHbM:ExampleItem", ExampleRecipeGroup);
		...
		public override void AddRecipes()
		{
			...
			resultItem.CreateRecipe()
				...
				.AddRecipeGroup("Wood")
				.AddRecipeGroup("TerrariaHbM:ExampleItem", 2)
