...
namespace TerrariaHbM.Content.Items.Accessories
{
	[AutoloadEquip(EquipType.Wings)]
	public class ExampleWings : ModItem
	{
		// To see how this config option was added, see SuspiciousYellowTriangleConfig.cs
		public override bool IsLoadingEnabled(Mod mod)
		{
			return ModContent.GetInstance<SuspiciousYellowTriangleConfig>().ExampleWingsToggle;
		}
